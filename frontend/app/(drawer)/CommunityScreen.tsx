...
const PostItem = ({ item, index, onLike }: { item: Post; index: number; onLike: (id: string) => void }) => {
...
export default function CommunityScreen() {
  ...
  const { communityPostsThisMonth, maxCommunityPosts } = useSubscription();
  ...
  const renderPost = ({ item, index }: { item: Post; index: number }) => {
    return <PostItem item={item} index={index} onLike={handleLike} />;
  };
